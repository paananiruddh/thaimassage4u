...
export default function Home() {
  ...
  return <><SiteHeader /><main>
    <section className="home-hero" style={{ backgroundImage: `url(${heroImage})` }}>
      ...
      <div className="home-hero__content"><p className="eyebrow">Thai Massage For U</p><h1>Find exceptional<br /><em>Thai massage</em> near you.</h1><p className="home-hero__lede">A city-by-city directory of independently listed Thai massage studios — traditional, oil, deep tissue and more — plus the wider wellness places worth knowing about.</p><Link href="/directory" className="dark-button">Explore the directory <ArrowUpRight size={16} /></Link></div>
      <div className="hero-search-dock"><div><MapPin size={19} /><span><small>Where are you looking?</small><strong>{cities[0]?.name || "Choose a city"}</strong></span></div><div className="hero-search-dock__divider" /><div><Sparkles size={18} /><span><small>What would feel good?</small><strong>Traditional Thai, oil, deep tissue</strong></span></div><button type="button" onClick={() => setLocation("/directory")} aria-label="Search the directory"><Search size={20} /></button></div>

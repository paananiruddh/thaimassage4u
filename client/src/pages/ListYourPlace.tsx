...
export default function ListYourPlace() {
  return <><SiteHeader /><main>
    <PageIntro eyebrow="For independent studios" title="Be found by people who are looking with intention." description="Thai Massage For U is for thoughtful places: therapists, studios, recovery spaces, and wellness practices that deserve a clearer introduction." />
    ...
    <section className="partner-assurance"><ShieldCheck size={27} /><p>Stripe manages payment credentials. Thai Massage For U stores only the identifiers needed to connect placement to the correct profile.</p></section>
  </main><SiteFooter /></>;
}
